            ...
            case
              ...
              -- Transfers done 25th April, 2024
                ...
                when upper(substring(sales.sales_person, 0, 7)) in ('KE2177','KE6913','KE6318','KE2333','KE3033','KE4785','KE5249','KE6103','KE6912','KE4604')
                    then 'KE7855'
                   -- transfers done on 23th May, 2024
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1030', 'KE0898', 'KE1195','KE1278','KE3046','KE1944','KE2926','KE4336','KE1807','KE5794','KE1374','KE1571','KE1803','KE2133','KE2337','KE2867','KE7666')
                    then 'KE5558'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE2870', 'KE7467','KE2946', 'KE1376', 'KE2134', 'KE3923', 'KE3796', 'KE2831', 'KE2874','KE2982', 'KE3850', 'KE3909', 'KE2984', 'KE0889', 'KE2019', 'KE2937', 'KE3144', 'KE4886', 'KE4970', 'KE7646')
                    then 'KE3405'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE2857', 'KE2927', 'KE2834', 'KE1026', 'KE2017', 'KE2340', 'KE1933', 'KE2020', 'KE7708', 'KE1042', 'KE7394', 'KE1028')
                    then 'KE7389'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0892', 'KE1319', 'KE3111', 'KE3231', 'KE1029', 'KE1947', 'KE2135', 'KE2138', 'KE0897', 'KE2339', 'KE1934', 'KE1940', 'KE1061', 'KE1569', 'KE1945', 'KE4606', 'KE2021', 'KE2022')
                    then 'KE7393'   
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0895', 'KE1565', 'KE1942', 'KE2165')
                    then 'KE7466'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE3082', 'KE0783', 'KE3792', 'KE0803', 'KE4404')
                    then 'KE0848'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE7445', 'KE0828', 'KE7444', 'KE2847', 'KE0879')
                    then 'KE2541'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1347')
                    then 'KE0798'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE2766', 'KE0907', 'KE0992', 'KE1527', 'KE6701')
                    then 'KE3880'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1470', 'KE3393', 'KE3786', 'KE6105')
                    then 'KE5294'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE3075','KE3392','KE3080','KE2904','KE2270')
                    then 'KE7663'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0989','KE2735')
                    then 'KE1157'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE3153')
                    then 'KE4757'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE3075')
                    then 'KE1520'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE6597', 'KE6952', 'KE6330', 'KE5575', 'KE5503')
                    then 'KE7832'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE7242', 'KE5500')
                    then 'KE7848'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0795', 'KE1121', 'KE2426', 'KE0171', 'KE1279', 'KE0779', 'KE7341', 'KE7539')
                    then 'KE0744'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE3020', 'KE0761', 'KE0762', 'KE0749', 'KE3309')
                    then 'KE0747'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1160','KE1457','KE0769','KE2334','KE0745','KE1558','KE3329','KE1927','KE7755','KE1353','KE1760','KE1929','KE3327','KE1559','KE7079','KE7588','KE7092','KE3019','KE4293','KE7094','KE2331','KE4433','KE7334','KE7338','KE7340','KE0748','KE1556','KE19312', 'KE5460', 'KE3768', 'KE5811', 'KE6340', 'KE7078', 'KE1123', 'KE1613', 'KE3328', 'KE5895','KE5924', 'KE6338', 'KE7820', 'KE0780', 'KE1561', 'KE1759', 'KE1928', 'KE4103', 'KE5896', 'KE5902', 'KE7076', 'KE7077', 'KE7091')
                    then 'KE7737'
                -- transfers on 20th May, 2024
                when upper(substring(sales.sales_person, 0, 7)) in ('KE7400', 'KE6876')
                    then 'KE7748'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0865', 'KE7718')
                    then 'KE7537'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1450', 'KE1217')
                    then 'KE2330'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0710')
                    then 'KE7281'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE4639', 'KE2616')
                    then 'KE7488'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1090', 'KE0260', 'KE2809')
                    then 'KE4953'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE3117', 'KE0586', 'KE3439', 'KE5653', 'KE1159', 'KE3115', 'KE1261')
                    then 'KE7754'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE2444', 'KE0321', 'KE1064')
                    then 'KE4171'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1226', 'KE1431', 'KE2962', 'KE3120')
                    then 'KE0480'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE6031', 'KE5123', 'KE3950', 'KE1057', 'KE3121')
                    then 'KE6625'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE6877', 'KE7597', 'KE7611', 'KE7622')
                    then 'KE5539'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE6708', 'KE4723', 'KE4305', 'KE4722')
                    then 'KE7883'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0947', 'KE6839', 'KE5201', 'KE0256', 'KE0264', 'KE0273', 'KE0520', 'KE0522', 'KE3116', 'KE3421', 'KE3436', 'KE3949', 'KE4170', 'KE4510', 'KE4675', 'KE6296', 'KE7596')
                    then 'KE7876'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE2078', 'KE2963', 'KE0523')
                    then 'KE6094'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1430')
                    then 'KE5935'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE3686')
                    then 'KE7916'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE0835', 'KE2710')
                    then 'KE1768'
                when upper(substring(sales.sales_person, 0, 7)) in ('KE1076')
                    then 'KE5514'
