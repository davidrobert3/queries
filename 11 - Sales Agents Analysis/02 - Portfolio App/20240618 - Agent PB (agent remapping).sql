...
rp_sales as (
    select
        ...
        case
            ...
            when upper(substring(sales.sales_person, 0, 7)) in (
                'KE3974',
                'KE0595',
                'KE0648',
                'KE1953',
            ...
            when upper(substring(sales.sales_person, 0, 7)) in ('KE6898', 'KE7812', 'KE6342') then 'KE7525'
            when upper(substring(sales.sales_person, 0, 7)) in (
                'KE4819',
                'KE6133',
                'KE6345',
            ...
            when upper(substring(sales.sales_person, 0, 7)) in (
                ...
                'KE6912',
                'KE4604'
            ) then 'KE7855' -- transfers done on 23th May, 2024
            when upper(substring(sales.sales_person, 0, 7)) in (
                'KE1030',
                'KE0898',
                'KE1195',
            ...
            when upper(substring(sales.sales_person, 0, 7)) in (
                ...
                'KE7077',
                'KE7091'
            ) then 'KE7737' -- transfers on 20th May, 2024
            ...
            when upper(substring(sales.sales_person, 0, 7)) in (
                ...
                'KE0116',
                'KE0462'
            ) then 'KE7562' -- transfers done on 30th May
