      ...
      and payments.third_party_payment_ref_id not like '%BONUS%'
              ...
              from collection_rate as collection_rate 
                             left join last_7_day_CR as last_7_day_CR 
                                            on last_7_day_CR.sales_order_id = collection_rate.unique_account_id 
...
case 
			...
			where upper(dataset.customer_name) not like '%OPTED OUT%' or upper(dataset.customer_name) not like '%OPTED  OUT%'