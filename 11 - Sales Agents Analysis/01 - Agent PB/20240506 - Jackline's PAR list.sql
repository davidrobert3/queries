...
payments AS (
    ...
    WHERE payments.processing_status = 'posted'
        AND payments.reconciliation_utc_timestamp::DATE >= current_date - INTERVAL '6 MONTH'
...
last_30_day_CR AS (
    ...
    WHERE payments.processing_status = 'posted'
        AND payments.reconciliation_utc_timestamp::TEXT::DATE BETWEEN current_date - 30 AND current_date
